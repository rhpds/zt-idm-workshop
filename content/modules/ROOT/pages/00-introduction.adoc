...
* 1 Red Hat Identity Management Replica
* 2 IdM clients

You will access the lab systems through the terminal window and the Identity Management Web UI. 
You will also have access to the RHEL Web UI for the clients where appropriate. 
As you progress through the labs in this workshops, the required tabs will be displayed.
