...
Accept the default to look for DNS forwarder configuration found by the search of resolv.conf by pressing *Enter* or typing *yes*.
Accept the default or type yes. You should get a message stating that it already exists.
