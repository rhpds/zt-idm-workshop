...
Client installation
The first step of replica creation is to enrol the machine that will become the replica. SSH to the replica VM and enrol it per :ref:`Unit 2: Enrolling client machines <2-client-install>`
...
You can proceed to :ref:`Unit 8: Sudo rule management <8-sudorule>` or :ref:`return to the curriculum overview <curriculum-overview>` to see all the available topics.