...
REMOTE_* REQUEST VARIABLES:
  ...
  REMOTE_PORT: 51876
You can now proceed to :ref:`Unit 7: Replica installation <7-replica-install>` or :ref:`Unit 8: Sudo rule management <8-sudorule>`. Otherwise, :ref:`return to the curriculum overview <curriculum-overview>` to see all the options.